...
const Top = () => {
    return(
        <>
            <div className="grid grid-cols-5 gap-1 h-32 py-10 text-center text-white mr-1">
               <div className="bg-[#2C3137] pt-3 font-semibold">BETS</div>
               <div className="col-span-3 flex bg-[#2C3137] items-center">
                    <div className="fixed"><img src={Logo} alt="logo" className="h-8 ml-1 w-24 text-left"></img></div>
