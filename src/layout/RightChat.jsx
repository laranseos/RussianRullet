    ...
    return(
        <>
            <div className="bg-[#20252b] h-screen">
                <div className=" h-12 items-center text-center shadow-md shadow-black grid grid-cols-6">
                ...
                <div className="mt-2 mb-2">
                    <div className="font-semibold flex">
                        <span className="flex text-black bg-[#9c30a0] h-5 rounded-md px-2 ml-2 ">
                        ...
                        <span className="text-white">
                            <span className=" text-[#9c30a0] ml-2">Kusti</span>: consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Malesuada nunc vel risus commodo viverra maecenas. Sit amet commodo nulla facilisi
                        </span>
                    </div>
                    <div className="font-semibold flex">
                        <span className="flex text-black bg-[#1a6652] h-5 rounded-md px-2 ml-2 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-3 h-3 mt-1 bi bi-star-fill" viewBox="0 0 16 16"> <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg>
                            <span>24</span>
                        </span>
                        <span className="text-white">
                    ...
                    <div className="font-semibold flex">
                        <span className="flex text-black bg-[#992222] h-5 rounded-md px-2 ml-2 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-3 h-3 mt-1 bi bi-star-fill" viewBox="0 0 16 16"> <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg>
                            <span>117</span>
                        </span>
                        <span className="text-white">
                    ...
                    <div className="bg-[#383c41] w-full h-16 flex mt-1">
                    ...
                    <div className="font-semibold mt-1 flex">
                        <span className="flex bg-[#0a0909] h-5 rounded-md px-2 ml-2 items-center">
                    ...
                    <div className=" text-white ml-4 font-semibold">:ut lectus arcu at varius. Id venenatis a condimentum vitae sapien pellentesque W ADMIN bibendum</div>

                    <div className="font-semibold flex">
                        <span className="flex bg-[#f6f5f5] h-5 rounded-md px-2 ml-2 items-center">
                    ...
                    <div className=" text-white ml-4 font-semibold">:isi porta lorem mollis aliquam ut porttitor leo</div>
