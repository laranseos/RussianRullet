    ...
    return(
        <>
            <div className="bg-[#20252b] h-screen">
                ...
                <div className="mt-2 mb-2 px-2 space-y-0.5 h-5/6 overflow-hidden">
                    <p className="font-semibold">
                        ...
                        <span className=" text-[#9c30a0] ml-2 text-wh">Kusti</span><span className="text-white">: consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Malesuada nunc vel risus commodo viverra maecenas. Sit amet commodo nulla facilisi</span>
                    </p>
                    <p className="font-semibold">
                ...
                <div className="h-20 mx-1 text-center">
