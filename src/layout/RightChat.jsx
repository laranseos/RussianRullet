    ...
    return(
        <>
            <div className="bg-[#20252b] h-screen">
                ...
                <div className="h-8 mt-2 text-center justify-center items-center bg-[#141117] text-white font-semibold w-full rounded-md"><label className=" mt-auto mb-auto">Send a message</label></div>
                <div className="grid grid-cols-6 mt-4">
                    ...
                    <button className="bg-[#f8bf60] w-12 h-6 font-semibold text-lg rounded-md">Chat</button>
                </div>
            </div>
        </>
    )
